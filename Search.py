    ...
    with codecs.open(outputfilename, 'ab', encoding='utf8') as outputfile:
        ...
        while True:
            ...
            for result in body:
                ...
                row = [page, result_id, title.encode('utf-8'), url, path, header_image_url, annotation_count,
                       pyongs_count, primaryartist_id, primaryartist_name, primaryartist_url, primaryartist_imageurl]
                # print row
